...
export BUILDER_IMAGE_NAME="taichicoin-builder-$BUILD_TARGET-$JOB_NUMBER"
...
if [ "$BUILD_TARGET" = "arm-linux" ]; then
  ...
  export USE_SHELL="/bin/taichicoin"
  export PYZMQ=true
  export RUN_UNITTESTS=true
  ...
  export CPPFLAGS="-DDEBUG_LOCKORDER -DENABLE_TAICHICOIN_DEBUG"
  export PYZMQ=true
  export RUN_UNITTESTS=true
  export RUN_INTEGRATIONTESTS=true
