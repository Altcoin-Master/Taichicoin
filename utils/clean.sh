...
rm -f src/config/taichicoin-config.h
...
rm -rf test_bitcoin.coverage/ taichicoin-gtest.coverage/ total.coverage/
...
clean_exe src/taichicoin-cli
clean_exe src/taichicoind
clean_exe src/taichicoin-gtest
clean_exe src/taichicoin-tx
clean_exe src/test/test_taichicoin
clean_exe src/test/test_taichicoin_fuzzy
...
clean_dep . src/config/taichicoin-config.h.in
