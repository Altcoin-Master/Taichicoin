...
from test_framework.test_framework import TaichicoinTestFramework
...
class LLMQChainLocksTest(TaichicoinTestFramework):
    def set_test_params(self):
        self.set_taichicoin_test_params(6, 5, fast_dip3_enforcement=True)
