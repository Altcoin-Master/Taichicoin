...
* taichicoin.conf: contains configuration settings for taichicoind or taichicoin-qt
* taichicoind.pid: stores the process id of taichicoind while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by taichicoind or taichicoin-qt
