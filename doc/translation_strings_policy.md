...
This document provides guidelines for internationalization of the Taichicoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `taichicoin_en.ts` remains unchanged.
