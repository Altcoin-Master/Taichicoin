...
This mechanism has been integrated into Bitcore-Node-Taichicoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Altcoin-Master/insight-api-taichicoin#web-socket-api](https://github.com/Altcoin-Master/insight-api-taichicoin#web-socket-api)
* API: [https://github.com/Altcoin-Master/insight-api-taichicoin#instantsend-transactions](https://github.com/Altcoin-Master/insight-api-taichicoin#instantsend-transactions)
