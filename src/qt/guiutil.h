...
/** Utility functions used by the Taichicoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "taichicoin:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load taichicoin specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a taichicoin specific theme is activated (light/dark).*/
