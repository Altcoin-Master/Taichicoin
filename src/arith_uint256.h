...
#ifndef TAICHICOIN_ARITH_UINT256_H
#define TAICHICOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Taichicoin only uses this "compact" format for encoding difficulty
...
#endif // TAICHICOIN_ARITH_UINT256_H
