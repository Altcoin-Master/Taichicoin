...
{
    const char* pszTimestamp = "03/01/2023 Taichicoin";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Taichicoin: 1 day
        consensus.nPowTargetSpacing = 2 * 60; // Taichicoin: 2 minutes
        ...
        consensus.defaultAssumeValid = uint256S("0xd3e6e35acbed52c47876c88ad378b78f1f3858de97679625e10e20f333b5f75e"); // 0
         ...
         */
        pchMessageStart[0] = 0x74;//l
        pchMessageStart[1] = 0x63;//b
        pchMessageStart[2] = 0x63;//r
        pchMessageStart[3] = 0x2e;//m
        nDefaultPort = 21003;
        nPruneAfterHeight = 100000;
        //FindMainNetGenesisBlock(1677548530, 0x20001fff, "main");
        genesis = CreateGenesisBlock(1677548530, 1080, 0x20001fff, 4, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x5c617bd81f112c8bf3bdcd73b51e481f16d8907b3728de430651ec10c2fe8123"));
        assert(genesis.hashMerkleRoot == uint256S("0x71bc4268bd59c03ca02e900489803819103268920ff340579f3d43177a3c6225"));

        vSeeds.emplace_back("seed01.taichicoin.org");
        vSeeds.emplace_back("seed02.taichicoin.org");
        vSeeds.emplace_back("seed03.taichicoin.org");

        // Taichicoin addresses start with 'L'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,66);
        // Taichicoin script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,16);
        // Taichicoin private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,128);
        // Taichicoin BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // Taichicoin BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};
        // Taichicoin BIP44 coin type is '5'
...
//        	exit(0);
//        }
        std::vector<FounderRewardStructure> rewardStructures = {  {INT_MAX, 2} };// 5% founder/dev fee forever
...
/*         consensus.nCollaterals = SmartnodeCollaterals(
        ...
        vSporkAddresses = {"TdpWLK3jonjfkEYxT2zGqUfWtmcDELfahX"};
        nMinSporkKeys = 1;
        fBIP9CheckSmartnodesUpgraded = true;

        checkpointData = {
          {  {0, uint256S("0x5c617bd81f112c8bf3bdcd73b51e481f16d8907b3728de430651ec10c2fe8123")},
		     {5000, uint256S("0xd3e6e35acbed52c47876c88ad378b78f1f3858de97679625e10e20f333b5f75e")},
		     //{16000, uint256S("0xf50a04ad1a1f08d0304d5dde2eeb25cb6c62c4579d36e4a2a902c7d8d3c27d8c")},
          }
        };

        chainTxData = ChainTxData{
            1678247385,//1672502400,   // * UNIX timestamp of last known number of transactions (Block 0)
            15545,   // * total number of transactions between genesis and that timestamp
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Taichicoin: 1 day
        consensus.nPowTargetSpacing = 60; // Taichicoin: 1 minutes
       ...
       // FindMainNetGenesisBlock(1645942755,  0x20001fff, "test");
        ...
        //vSeeds.emplace_back("ger1.taichicoin.org", true);
        //vSeeds.emplace_back("ny1.taichicoin.org", true);

        // Testnet Taichicoin addresses start with 'r'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,123);
        // Testnet Taichicoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Taichicoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Taichicoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet Taichicoin BIP44 coin type is '1' (All coin's testnet default)
        std::string strExtCoinType = gArgs.GetArg("-extcoinindex", "");
        ...
        chainTxData = ChainTxData{
            1677548530, // * UNIX timestamp of last known number of transactions (Block 213054)
...
public:
    CDevNetParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 2; // DIP0003 activated immediately on devnet
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Taichicoin: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // Taichicoin: 2.5 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = false;
        consensus.nPowDGWHeight = 60;
        consensus.DGWBlocksAvg = 60;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("taichicoin.org",  "devnet-seed.taichicoin.org"));

        // Testnet Taichicoin addresses start with 'y'
...
public:
    CRegTestParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 500;
        ...
        // Regtest Taichicoin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Taichicoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Taichicoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Taichicoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Taichicoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
