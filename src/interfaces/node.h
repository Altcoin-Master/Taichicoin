...
//! Interface for the src/evo part of a taichicoin node (taichicoind process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a taichicoin node (taichicoind process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a taichicoin node (taichicoind process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a taichicoin node (taichicoind process).
class Node
{
public:
    virtual ~Node() {}
