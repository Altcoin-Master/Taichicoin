Contributing to Taichicoin Core
============================

The Taichicoin Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Qt* for changes to taichicoin-qt
...
[Translation Process](https://github.com/Altcoin-Master/taichicoin/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Taichicoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Taichicoin
Network Protocol consensus changes.

Whether a pull request is merged into Taichicoin Core rests with the project merge
...
Patches that change Taichicoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Taichicoin consensus, it must have been
...
The review process is normally fairly responsive on the Taichicoin Core repository, however
...
The project leader is the release manager for each Taichicoin Core release.
